...
// .splice()  - видалення сатини елементів з масиву (змінює масив видаляючи або додаючи нові елементи) (він дуже параметризований, його можна по різному використовувати. Перший параметр обовязковий це індекс з якого починаємо зміни, відємний індекс використовується щоб почати з кінця масиву)
